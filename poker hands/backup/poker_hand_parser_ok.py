...
class PokerHandParser:
    def __init__(self):
        ...
        self.preflop_line1_completed = False
        self.preflop_line2_completed = False
        self.current_preflop_line = 1
        self.last_raiser = ''
        self.line2_end_player = ''
